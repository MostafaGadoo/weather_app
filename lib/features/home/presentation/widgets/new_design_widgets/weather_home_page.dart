...
class WeatherHomepageWidget extends StatelessWidget {
  const WeatherHomepageWidget({Key? key}) : super(key: key);
                  ...
                  Stack(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          '${cubit.tempMainWeather}'.split('.').first,
                          style: TextStyle(
                  ...
                  Stack(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          '${cubit.minTempMainWeather}'.split('.').first,
                          style: TextStyle(
                            color: HexColor('#444f6b'),
                            fontSize: 24,
                          ),
                  ...
                  Stack(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          '${cubit.maxTempMainWeather}'.split('.').first,
                          style: TextStyle(
                        ...
                        Stack(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(
                                '${cubit.feelsLikeTempMainWeather}'.split('.').first,
                                style: TextStyle(
                                  color: HexColor('#444f6b'),
                                  fontSize: 20,
                                ),
